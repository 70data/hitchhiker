...
wget http://mirror.centos.org/altarch/7/kernel/x86_64/Packages/kernel-tools-5.4.65-200.el7.x86_64.rpm

wget http://mirror.centos.org/altarch/7/kernel/x86_64/Packages/kernel-tools-libs-5.4.65-200.el7.x86_64.rpm

wget http://mirror.centos.org/altarch/7/kernel/x86_64/Packages/perf-5.4.65-200.el7.x86_64.rpm

wget http://mirror.centos.org/altarch/7/kernel/x86_64/Packages/python3-perf-5.4.65-200.el7.x86_64.rpm
```
