https://docs.cilium.io/en/v1.7/policy/
...
kubectl exec tiefighter -- curl -s -XPOST deathstar.default.svc.cluster.local/v1/request-landing 由于没有执行规则，和都可以请求着陆。要测试这一点，请使用下面的命令。
```
